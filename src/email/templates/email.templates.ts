...
export class EmailTemplates {
  static connectionAcceptedEmail(senderName: string, recipientName: string, profileUrl: string): string {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  static commentNotificationEmail(recipientName: string, commenterName: string, postUrl: string, commentContent: string): string {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  static welcomeEmail(name: string, profileUrl: string): string {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
